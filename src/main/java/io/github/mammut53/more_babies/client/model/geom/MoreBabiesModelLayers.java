...
public class MoreBabiesModelLayers {
    ...
    public static final ModelLayerLocation ELDER_GUARDIAN = register("elder_guardian_baby");
    ...
    public static final ModelLayerLocation GUARDIAN = register("guardian_baby");
