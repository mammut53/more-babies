...
public class MoreBabiesModelLayers {
    ...
    public static final ModelLayerLocation BREEZE_BABY = register("breeze_baby");
    ...
    public static final ModelLayerLocation ELDER_GUARDIAN_BABY = register("elder_guardian_baby");
    public static final ModelLayerLocation ENDERMAN_BABY = register("enderman_baby");
    ...
    public static final ModelLayerLocation GIANT_BABY = register("giant_baby");
    public static final ArmorModelSet<ModelLayerLocation> GIANT_BABY_ARMOR = registerArmorSet("giant_baby");
    public static final ModelLayerLocation GUARDIAN_BABY = register("guardian_baby");
    ...
    public static final ModelLayerLocation PARCHED_BABY_OUTER_LAYER = register("parched_baby", "outer");
    ...
    public static final ModelLayerLocation RAVAGER_BABY = register("ravager_baby");
    ...
    public static final ModelLayerLocation STRAY_BABY = register("stray_baby");
    ...
    public static final ModelLayerLocation WARDEN_BABY = register("warden_baby");
    public static final ModelLayerLocation WARDEN_BABY_BIOLUMINESCENT = register("warden_baby", "bioluminescent");
    public static final ModelLayerLocation WARDEN_BABY_PULSATING_SPOTS = register("warden_baby", "pulsating_spots");
    public static final ModelLayerLocation WARDEN_BABY_TENDRILS = register("warden_baby", "tendrils");
    public static final ModelLayerLocation WARDEN_BABY_HEART = register("warden_baby", "heart");
    ...
    private static Map<ModelLayerLocation, ModelLayerLocation> createGuardianBabyMap() {
        ...
        result.put(ModelLayers.ELDER_GUARDIAN, ELDER_GUARDIAN_BABY);
        result.put(ModelLayers.GUARDIAN, GUARDIAN_BABY);
        return result;
    }
