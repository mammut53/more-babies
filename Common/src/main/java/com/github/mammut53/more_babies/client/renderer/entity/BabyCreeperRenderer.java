...
public class BabyCreeperRenderer extends MobRenderer<Creeper, CreeperModel<Creeper>> {
    ...
    public BabyCreeperRenderer(EntityRendererProvider.Context context) {
        super(context, new BabyCreeperModel(context.bakeLayer(ModelLayers.CREEPER)), 0.5F);
